  ...
  return (
    <div className={'block-wrapper'}>
      ...
      <div className={'changes__row'}>
        <ul className={'changes__left text_2'}>
          <li>
            <span>100%</span>
            <span>result</span>
          </li>
        ...
        <div className={'changes__right'}>
            ...
            <div className={'changes__circle'}>8</div>
            <div className={'changes__circle'}>63</div>
            <div className={'changes__circle'}>25</div>
            <div className={'changes__circle'}>100</div>
            <div className={'changes__circle'}>4</div>
        </div>
      </div>
    </div>
  );
